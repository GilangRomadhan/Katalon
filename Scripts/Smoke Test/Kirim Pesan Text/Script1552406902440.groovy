...
Mobile.setText(findTestObject('General/general.textField - Search contact  group'), '08995097611', 1)
...
Mobile.verifyElementVisible(findTestObject('Chat/chat.symbol-Terkirim'), 1, FailureHandling.OPTIONAL)
